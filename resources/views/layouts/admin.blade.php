...
<body class="bg-gray-100 min-h-screen flex antialiased">
    ...
    <aside class="w-64 bg-gray-900 text-white min-h-screen flex flex-col shrink-0">
        ...
        <nav class="flex-1 p-4 space-y-1 text-sm">
            ...
            <a href="{{ route('admin.fixtures.scores.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.fixtures.scores*') ? 'bg-brand-600 text-white' : 'text-gray-400 hover:bg-white/10 hover:text-white' }}">
